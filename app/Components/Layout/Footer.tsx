...
const Footer = () => {
    return (
                    ...
                    <div className="grid grid-cols-2 gap-5 px-4 py-6 md:space-x-16  lg:py-8 md:grid-cols-4">
                        <div>
                            ...
                            <div className="flex border  mb-5 w-fit">
                                <input type="text" placeholder="Type..." className="px-1 h-6 w-20 md:h-7 lg:h-8 lg:w-40 md:w-28" />
        ...
        <div className="flex mt-4 space-x-6 sm:justify-center md:mt-0">
            <a href="#" className="text-[#30207a] hover:text-gray-900 dark:hover:text-white">
            ...
            <a href="https://github.com/mahsanr44" className="text-[#30207a] hover:text-gray-900 dark:hover:text-white">
